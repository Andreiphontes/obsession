...
{
    Ogre::ResourceGroupManager::getSingleton ().addResourceLocation ("/home/cortana/ClionProjects/OgreApp/media", "FileSystem");
    Ogre::ResourceGroupManager::getSingleton ().addResourceLocation ("/home/cortana/ClionProjects/OgreApp/media/Sinbad.zip", "Zip");
    Ogre::ResourceGroupManager::getSingleton ().addResourceLocation ("/home/cortana/ClionProjects/OgreApp/media/cubemap.zip", "Zip");
